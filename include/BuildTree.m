...
iTj(3,1,1) = 0; iTj(3,2,1) = 0; iTj(3,3,1) = 1; iTj(3,4,1) = 0.23;
iTj(4,1,1) = 0; iTj(4,2,1) = 0; iTj(4,3,1) = 0; iTj(4,4,1) = 1;

iTj(1,1,2) = 0 ; iTj(1,2,2) = -1; iTj(1,3,2) = 0; iTj(1,4,2) = -0.15;
iTj(2,1,2) = 0; iTj(2,2,2) = 0; iTj(2,3,2) = -1; iTj(2,4,2) = 0;
iTj(3,1,2) = 1; iTj(3,2,2) = 0; iTj(3,3,2) = 0; iTj(3,4,2) = 0.2;
iTj(4,1,2) = 0; iTj(4,2,2) = 0; iTj(4,3,2) = 0; iTj(4,4,2) = 1;

iTj(1,1,3) = 1; iTj(1,2,3) = 0; iTj(1,3,3) = 0; iTj(1,4,3) = 0.59;
...
iTj(1,1,4) = 0; iTj(1,2,4) = -1; iTj(1,3,4) = 0; iTj(1,4,4) = 0.13;
iTj(2,1,4) = 0; iTj(2,2,4) = 0; iTj(2,3,4) = -1; iTj(2,4,4) = -0.1;
...
iTj(3,1,5) = 0; iTj(3,2,5) = 0; iTj(3,3,5) = 1; iTj(3,4,5) = 0.35;
iTj(4,1,5) = 0; iTj(4,2,5) = 0; iTj(4,3,5) = 0; iTj(4,4,5) = 1;

iTj(1,1,6) = 0; iTj(1,2,6) = 0; iTj(1,3,6) = 1; iTj(1,4,6) = 0;
iTj(2,1,6) = 1; iTj(2,2,6) = 0; iTj(2,3,6) = 0; iTj(2,4,6) = 0;
iTj(3,1,6) = 0; iTj(3,2,6) = 1; iTj(3,3,6) = 0; iTj(3,4,6) = 0.234;
...
iTj(2,1,7) = 0; iTj(2,2,7) = 0; iTj(2,3,7) = 1;  iTj(2,4,7) = 0.1;
